...
5. Enter your name and email in the Reader card.
...
10. Send the transcript JSON to the person coordinating the exercise, if requested.
...
3. Choose one or more reader transcript JSON files.
...
- Use the same browser and computer while doing the reader exercise.
